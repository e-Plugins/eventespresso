 ...
 */
class EE_PMT_Paysafecard extends EE_PMT_Base
{

    public $tpPaymethodDisplayName = 'Paysafecard';
    ...
    {
        require_once ($this->file_folder() . 'EEG_Paysafecard.gateway.php');
        $this->_gateway = new EEG_Paysafecard();
