 ...
 */
class EE_PMT_Bancontact extends EE_PMT_Base
{

    public $tpPaymethodDisplayName = 'Bancontact';
    ...
    {
        require_once ($this->file_folder() . 'EEG_Bancontact.gateway.php');
        $this->_gateway = new EEG_Bancontact();
