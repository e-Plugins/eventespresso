 ...
 */
class EE_PMT_Paypal extends EE_PMT_Base
{

    public $tpPaymethodDisplayName = 'Paypal';
    ...
    {
        require_once ($this->file_folder() . 'EEG_Paypal.gateway.php');
        $this->_gateway = new EEG_Paypal();
