 ...
 */
class EE_PMT_Giropay extends EE_PMT_Base
{

    public $tpPaymethodDisplayName = 'Giropay';
    ...
    {
        require_once ($this->file_folder() . 'EEG_Giropay.gateway.php');
        $this->_gateway = new EEG_Giropay();
