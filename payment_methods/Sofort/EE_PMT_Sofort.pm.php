 ...
 *          ------------------------------------------------------------------------
 */
class EE_PMT_Sofort extends EE_PMT_Base
{

    public $tpPaymethodDisplayName = 'Sofort';
    ...
    public function __construct($pm_instance = null)
    {
        ...
        require_once ($this->file_folder() . 'EEG_Sofort.gateway.php');
        $this->_gateway = new EEG_Sofort();
